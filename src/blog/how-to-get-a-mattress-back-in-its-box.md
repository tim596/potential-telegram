...
This method will only work for foam mattresses, so do not attempt with latex or spring ones.
...
If you decided to use a mattress bag that can be sealed, then you should go ahead and close the bag.
